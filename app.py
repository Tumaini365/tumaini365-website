...
# 4. PAGE VIEW: BOOK AN APPOINTMENT (With Mail Delivery Architecture)
    ...
    # Form embedded using HTML to leverage automated FormSubmit relay pathways
    contact_form_html = f"""
    <form action="https://formsubmit.co{TARGET_EMAIL}" method="POST" style="background-color: #FFFFFF; padding: 30px; border-radius: 12px; box-shadow: 0 4px 10px rgba(0,0,0,0.05);">
        ...
        <div style="margin-bottom: 15px;">
            ...
            <input type="email" name="Client Email" style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 6px;" required>
        </div>
        ...
        <div style="margin-bottom: 20px;">
            ...
            <input type="text" name="Requested Date and Time Slot" placeholder="e.g., Next Tuesday at 2:00 PM" style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 6px;" required>
        </div>
